...
declare class OrderedLazyIterable<V, C> extends LazyIterable<number, V, C> {
    public iterate(fn: (value?: V, index?: number, collection?: C) => any, thisArg?: any, maintainIndices?: boolean): boolean;
    ...
    public entries(): OrderedLazyIterable<any[], C>;
    ...
    public skipUntil(fn: (value?: V, index?: number, collection?: C) => boolean, thisArg?: any): OrderedLazyIterable<V, C>;
}
