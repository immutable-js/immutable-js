...
function lt(t){return!(!t||!t[Ir])}function vt(t,e){return S(t,e[0],e[1])}function yt(t,e){return{node:t,index:0,__prev:e}}function dt(t,e,r,n){var i=Object.create(zr);return i.size=t,i._root=e,i.__ownerID=r,i.__hash=n,i.__altered=!1,i}function gt(){return Er||(Er=dt(0))}function mt(t,r,n){var i,o;if(t._root){var u=e(ke),s=e(Ae);if(i=wt(t._root,t.__ownerID,0,void 0,r,n,u,s),!s.value)return t;o=t.size+(u.value?n===je?-1:1:0)}else{if(n===je)return t;o=1,i=new br(t.__ownerID,[[r,n]])}return t.__ownerID?(t.size=o,t._root=i,t.__hash=void 0,t.__altered=!0,t):i?dt(o,i):gt()}function wt(t,e,n,i,o,u,s,a){return t?t.update(e,n,i,o,u,s,a):u===je?t:(r(a),r(s),new Dr(e,i,[o,u]))}function St(t){return t.constructor===Dr||t.constructor===qr}function It(t,e,r,n,i){if(t.keyHash===n)return new qr(e,n,[t.entry,i]);var o,u=(0===r?t.keyHash:t.keyHash>>>r)&xe,s=(0===r?n:n>>>r)&xe;return new Or(e,1<<u|1<<s,u===s?[It(t,e,r+De,n,i)]:(o=new Dr(e,n,i),u<s?[t,o]:[o,t]))}function zt(t,e,r,i){t||(t=new n);for(var o=new Dr(t,K(r),[r,i]),u=0;u<e.length;u++){var s=e[u];o=o.update(t,0,void 0,s[0],s[1])}return o}function bt(t,e,r,n){for(var i=0,o=0,u=Array(r),s=0,a=1,c=e.length;s<c;s++,a<<=1){var h=e[s];void 0!==h&&s!==n&&(i|=a,u[o++]=h)}return new Or(t,i,u)}function Ot(t,e,r,n,i){for(var o=0,u=Array(Ee),s=0;0!==r;s++,r>>>=1)u[s]=1&r?e[o++]:void 0;return u[n]=i,new Mr(t,o+1,u)}function Mt(t,e,r){for(var n=[],i=0;i<r.length;i++)n.push(Be(r[i]));return Et(t,e,n)}function qt(t,e){return e}function Dt(t){return function(e,r,n){if(e&&r&&"object"==typeof r){if(e.mergeDeepWith)return e.mergeDeepWith(t,r);if(e.merge)return e.merge(r)}var i=t(e,r,n);return R(e,i)?e:i}}function Et(t,e,r){return r=r.filter(function(t){return 0!==t.size}),0===r.length?t:0!==t.size||t.__ownerID||1!==r.length?t.withMutations(function(t){for(var n=e?function(r,n){t.update(n,je,function(t){return t===je?r:e(t,r,n)})}:function(e,r){t.set(r,e)},i=0;i<r.length;i++)r[i].forEach(n)}):t.constructor(r[0])}function xt(t,e,r,n,i){var o=t===je;if(r===e.length){var u=o?n:t,s=i(u)
...
return null===t||void 0===t?me():de(t)?t:me().withMutations(function(e){var r=Je(t);pt(r.size),r.forEach(function(t){return e.add(t)})})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.of=function(){return this(arguments)},e.fromKeys=function(t){return this(Be(t).keySeq())},e.prototype.toString=function(){return this.__toString("OrderedSet {","}")},e}(Hr);en.isOrderedSet=de;var rn=en.prototype;rn[Le]=!0,rn.zip=tn.zip,rn.zipWith=tn.zipWith,rn.__empty=me,rn.__make=ge;var nn,on=function(t,e){var r,n=function(o){var u=this;if(o instanceof n)return o;if(!(this instanceof n))return new n(o);if(!r){r=!0;var s=Object.keys(t),a=i._indices={};i._name=e,i._keys=s,i._defaultValues=t;for(var c=0;c<s.length;c++){var h=s[c];a[h]=c,i[h]?"object"==typeof console&&console.warn&&console.warn("Cannot define "+Se(u)+' with property "'+h+'" since that property name is part of the Record API.'):ze(i,h)}}this.__ownerID=void 0,this._values=Rr().withMutations(function(t){t.setSize(u._keys.length),Be(o).forEach(function(e,r){t.set(u._indices[r],e===u._defaultValues[r]?void 0:e)})})},i=n.prototype=Object.create(un);return i.constructor=n,n};on.prototype.toString=function(){for(var t,e=this,r=Se(this)+" { ",n=this._keys,i=0,o=n.length;i!==o;i++)t=n[i],r+=(i?", ":"")+t+": "+_t(e.get(t));return r+" }"},on.prototype.equals=function(t){return this===t||t&&this._keys===t._keys&&Ie(this).equals(Ie(t))},on.prototype.hashCode=function(){return Ie(this).hashCode()},on.prototype.has=function(t){return this._indices.hasOwnProperty(t)},on.prototype.get=function(t,e){if(!this.has(t))return e;var r=this._indices[t],n=this._values.get(r);return void 0===n?this._defaultValues[t]:n},on.prototype.set=function(t,e){if(this.has(t)){var r=this._values.set(this._indices[t],e===this._defaultValues[t]?void 0:e);if(r!==this._values&&!this.__ownerID)return we(this,r)}return this},on.prototype.remove=function(t){return this.set(t)},on.prototype.clear=function(){var t=this._values.clear().setSize(this._keys.length)
;return this.__ownerID?this:we(this,t)},on.prototype.wasAltered=function(){return this._values.wasAltered()},on.prototype.toSeq=function(){return Ie(this)},on.prototype.toJS=function(){return Ie(this).toJS()},on.prototype.__iterator=function(t,e){return Ie(this).__iterator(t,e)},on.prototype.__iterate=function(t,e){return Ie(this).__iterate(t,e)},on.prototype.__ensureOwner=function(t){if(t===this.__ownerID)return this;var e=this._values.__ensureOwner(t);return t?we(this,e,t):(this.__ownerID=t,this._values=e,this)},on.isRecord=m,on.getDescriptiveName=Se;var un=on.prototype;un[Te]=!0,un.delete=un.remove,un.deleteIn=un.removeIn=zr.removeIn,un.getIn=Zr.getIn,un.hasIn=Zr.hasIn,un.merge=zr.merge,un.mergeWith=zr.mergeWith,un.mergeIn=zr.mergeIn,un.mergeDeep=zr.mergeDeep,un.mergeDeepWith=zr.mergeDeepWith,un.mergeDeepIn=zr.mergeDeepIn,un.setIn=zr.setIn,un.update=zr.update,un.updateIn=zr.updateIn,un.withMutations=zr.withMutations,un.asMutable=zr.asMutable,un.asImmutable=zr.asImmutable,un[Qe]=Zr.entries,un.toJSON=un.toObject=Zr.toObject,un.inspect=un.toSource=Zr.toSource;var sn,an=function(t){function e(t,r){if(!(this instanceof e))return new e(t,r);if(this._value=t,0===(this.size=void 0===r?1/0:Math.max(0,r))){if(sn)return sn;sn=this}}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.toString=function(){return 0===this.size?"Repeat []":"Repeat [ "+this._value+" "+this.size+" times ]"},e.prototype.get=function(t,e){return this.has(t)?this._value:e},e.prototype.includes=function(t){return R(this._value,t)},e.prototype.slice=function(t,r){var n=this.size;return a(t,r,n)?this:new e(this._value,h(r,n)-c(t,n))},e.prototype.reverse=function(){return this},e.prototype.indexOf=function(t){return R(this._value,t)?0:-1},e.prototype.lastIndexOf=function(t){return R(this._value,t)?this.size:-1},e.prototype.__iterate=function(t,e){for(var r=this,n=this.size,i=0;i!==n&&t(r._value,e?n-++i:i++,r)!==!1;);return i},e.prototype.__iterator=function(t,e){var r=this,n=this.size,i=0
;return new Xe(function(){return i===n?I():S(t,e?n-++i:i++,r._value)})},e.prototype.equals=function(t){return t instanceof e?R(this._value,t._value):Zt(t)},e}(Ze),cn={version:"4.0.0-rc.4",Collection:Ce,Iterable:Ce,Seq:Fe,Map:Sr,OrderedMap:Br,List:Rr,Stack:Jr,Set:Hr,OrderedSet:en,Record:on,Range:Gr,Repeat:an,is:R,fromJS:be,hash:K,isImmutable:_,isCollection:l,isKeyed:v,isIndexed:y,isAssociative:d,isOrdered:g,isValueObject:w},hn=Ce;t.default=cn,t.version="4.0.0-rc.4",t.Collection=Ce,t.Iterable=hn,t.Seq=Fe,t.Map=Sr,t.OrderedMap=Br,t.List=Rr,t.Stack=Jr,t.Set=Hr,t.OrderedSet=en,t.Record=on,t.Range=Gr,t.Repeat=an,t.is=R,t.fromJS=be,t.hash=K,t.isImmutable=_,t.isCollection=l,t.isKeyed=v,t.isIndexed=y,t.isAssociative=d,t.isOrdered=g,t.isValueObject=w,Object.defineProperty(t,"__esModule",{value:!0})});