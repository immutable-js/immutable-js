...
},has:function(t){return this._seq.has(t)},cacheResult:function(){return this._seq.cacheResult(),this.length=this._seq.length,this},__iterate:function(t,e){var r=this,n=0;return this._seq.__iterate(function(e){return t(e,n++,r)},e)},__iterator:function(t,e){var r=this._seq.__iterator(He,e),n=0;return new Ze(function(){var e=r.next();return e.done?e:l(t,n++,e.value,e)})}},{},nr);var fr=function(t){this._seq=t,this.length=t.length};Ce.createClass(fr,{get:function(t,e){return this._seq.get(t,e)},has:function(t){return this._seq.has(t)},valueSeq:function(){return this._seq},reverse:function(){var t=this,e=P(this);return e.valueSeq=function(){return t._seq.reverse()},e},map:function(t,e){var r=this,n=U(this,t,e);return n.valueSeq=function(){return r._seq.map(t,e)},n},cacheResult:function(){return this._seq.cacheResult(),this.length=this._seq.length,this},__iterate:function(t,e){var r=this,n=e?d(this):0;return this._seq.__iterate(function(i){return t(i,e?--n:n++,r)},e)},__iterator:function(t,e){var r=this._seq.__iterator(He,e),n=e?d(this):0;return new Ze(function(){var i=r.next();return i.done?i:l(t,e?--n:n++,i.value,i)})}},{},tr);var _r=function(t){this._seq=t,this.length=t.length};Ce.createClass(_r,{entrySeq:function(){return this._seq},cacheResult:function(){return this._seq.cacheResult(),this.length=this._seq.length,this},__iterate:function(t,e){var r=this;return this._seq.__iterate(function(e){return e&&t(e[1],e[0],r)},e)},__iterator:function(t,e){var r=this._seq.__iterator(He,e);return new Ze(function(){for(;;){var e=r.next();if(e.done)return e;var n=e.value;if(n)return t===Qe?e:l(t,n[0],n[1],e)}})}},{},tr);var lr=function(t,e,r,n){n=n?n:t.getIn(e),this.length=n instanceof tr?n.length:null,this._rootData=t,this._keyPath=e,this._onChange=r};Ce.createClass(lr,{deref:function(t){return this._rootData.getIn(this._keyPath,t)},get:function(t,e){if(Array.isArray(t)&&0===t.length)return this;var r=this._rootData.getIn(this._keyPath.concat(t),Ue);return r===Ue?e:T(this,t,r)},set:function(t,e){return G(this,function(r){return r.set(t,e)
