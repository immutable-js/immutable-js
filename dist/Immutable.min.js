...
return new er(function(){if(!i)return g();var e=i.next();if(e.done)return e;var n=e.value,u=n[0],a=n[1];return v(t,u,Oe(r,u,a),e)})}},{},nr),an.prototype[Re]=an.prototype.remove,an.prototype.getIn=an.prototype.get;var sn={Sequence:nr,Map:pr,Vector:Ar,Stack:Kr,Set:Vr,OrderedMap:Fr,Record:Qr,Range:Yr,Repeat:en,is:n,fromJS:xe};return sn}"object"==typeof exports?module.exports=t():"function"==typeof define&&define.amd?define(t):Immutable=t();