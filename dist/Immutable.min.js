...
var n=r>>>e&Je;if(n>=this.array.length)return new Kr([],t);var i,u=0===n;if(e>0){var a=this.array[n];if(i=a&&a.removeBefore(t,e-Ke,r),i===a&&u)return this}if(u&&!i)return this;var s=ge(this,t);if(!u)for(var o=0;n>o;o++)s.array[o]=void 0;return i&&(s.array[n]=i),s},removeAfter:function(t,e,r){if(r===e?1<<e:0||0===this.array.length)return this;var n=r-1>>>e&Je;if(n>=this.array.length)return this;var i,u=n===this.array.length-1;if(e>0){var a=this.array[n];if(i=a&&a.removeAfter(t,e-Ke,r),i===a&&u)return this}if(u&&!i)return this;var s=ge(this,t);return u||s.array.pop(),i&&(s.array[n]=i),s}},{});var zr=function(t,e,r){this._type=e,this._reverse=!!r,this._maxIndex=t.length-1;var n=ye(t._size),i=fe(t._root&&t._root.array,t._level,-t._origin,n-t._origin-1),u=fe(t._tail&&t._tail.array,0,n-t._origin,t._size-t._origin-1);this._stack=r?u:i,this._stack.__prev=r?i:u};We.createClass(zr,{next:function(){for(var t=this._stack;t;){var e=t.array,r=t.index++;if(this._reverse&&(r=Je-r,r>t.rawMax&&(r=t.rawMax,t.index=ze-r)),r>=0&&ze>r&&t.rawMax>=r){var n=e&&e[r];if(0===t.level){var i,u=this._type;return 1!==u&&(i=t.offset+(r<<t.level),this._reverse&&(i=this._maxIndex-i)),v(u,i,n)}this._stack=t=fe(n&&n.array,t.level-Ke,t.offset+(r<<t.level),t.max,t)}else t=this._stack=this._stack.__prev}return g()}},{},ir);var Jr,Br=function(){for(var t=[],e=0;arguments.length>e;e++)t[e]=arguments[e];return Lr.from(t)},Lr=Br;We.createClass(Br,{toString:function(){return this.__toString("Stack [","]")},get:function(t,e){for(var r=this._head;r&&t--;)r=r.next;return r?r.value:e},peek:function(){return this._head&&this._head.value},push:function(){if(0===arguments.length)return this;for(var t=this.length+arguments.length,e=this._head,r=arguments.length-1;r>=0;r--)e={value:arguments[r],next:e};return this.__ownerID?(this.length=t,this._head=e,this.__hash=void 0,this.__altered=!0,this):we(t,e)},pushAll:function(t){if(t=ar(t),0===t.length)return this;var e=this.length,r=this._head;return t.reverse().forEach(function(t){e++,r={value:t,next:r}}),this.__ownerID?(this.length=e,this._head=r,this.__hash=void 0,this.__altered=!0,this):we(e,r)
},pop:function(){return this.slice(1)},unshift:function(){return this.push.apply(this,arguments)},unshiftAll:function(t){return this.pushAll(t)},shift:function(){return this.pop.apply(this,arguments)},clear:function(){return 0===this.length?this:this.__ownerID?(this.length=0,this._head=void 0,this.__hash=void 0,this.__altered=!0,this):Lr.empty()},slice:function(t,e){if(S(t,e,this.length))return this;var r=I(t,this.length),n=b(e,this.length);if(n!==this.length)return We.superCall(this,Lr.prototype,"slice",[t,e]);for(var i=this.length-r,u=this._head;r--;)u=u.next;return this.__ownerID?(this.length=i,this._head=u,this.__hash=void 0,this.__altered=!0,this):we(i,u)},__ensureOwner:function(t){return t===this.__ownerID?this:t?we(this.length,this._head,t,this.__hash):(this.__ownerID=t,this.__altered=!1,this)},__iterateUncached:function(t,e){if(e)return this.cacheResult().__iterate(t,e);for(var r=0,n=this._head;n&&t(n.value,r++,this)!==!1;)n=n.next;return r},__iteratorUncached:function(t,e){if(e)return this.cacheResult().__iterator(t,e);var r=0,n=this._head;return new ir(function(){if(n){var e=n.value;return n=n.next,v(t,r++,e)}return g()})}},{empty:function(){return Nr||(Nr=we(0))},from:function(t){var e=Lr.empty();return t?t.constructor===Lr?t:e.unshiftAll(t):e}},hr);var Vr=Br.prototype;Vr.withMutations=Sr.withMutations,Vr.asMutable=Sr.asMutable,Vr.asImmutable=Sr.asImmutable,Vr.wasAltered=Sr.wasAltered;var Nr,Tr=function(){for(var t=[],e=0;arguments.length>e;e++)t[e]=arguments[e];return Fr.from(t)},Fr=Tr;We.createClass(Tr,{toString:function(){return this.__toString("Set {","}")},get:function(t,e){return this._map.has(t)?t:e},contains:function(t){return this._map.has(t)},add:function(t){var e=this._map.set(t,null);return this.__ownerID?(this.length=e.length,this._map=e,this):e===this._map?this:Se(e)},remove:function(t){var e=this._map.remove(t);return this.__ownerID?(this.length=e.length,this._map=e,this):e===this._map?this:0===e.length?Fr.empty():Se(e)},clear:function(){return 0===this.length?this:this.__ownerID?(this.length=0,this._map.clear(),this):Fr.empty()
...
var ln=function(t,e,r,n){this.length=n,this._rootData=t,this._keyPath=e,this._onChange=r};We.createClass(ln,{add:function(t){return je(this,function(e){return e.add(t)})},contains:function(t){return t.__deref().contains(t)},union:function(){var t=arguments;return je(this,function(e){return e.union.apply(e,t)})},intersect:function(){var t=arguments;return je(this,function(e){return e.intersect.apply(e,t)})},subtract:function(){var t=arguments;return je(this,function(e){return e.subtract.apply(e,t)})},isSubset:function(t){return this.__deref().isSubset(t)},isSuperset:function(t){return this.__deref().isSuperset(t)}},{},Tr);var vn=ln.prototype;vn[Pe]=vn.remove=cn.remove,vn.toString=cn.toString,vn.equals=cn.equals,vn.__deref=cn.__deref,vn.get=cn.get,vn.getIn=cn.getIn,vn.remove=cn.remove,vn.clear=cn.clear,vn.withMutations=cn.withMutations,vn.asMutable=cn.asMutable,vn.asImmutable=cn.asImmutable,vn.wasAltered=cn.wasAltered,vn.__iterate=cn.__iterate,vn.__iterator=cn.__iterator,vn.__ensureOwner=cn.__ensureOwner;var gn=function(t,e,r,n){this.length=n,this._rootData=t,this._keyPath=e,this._onChange=r};We.createClass(gn,{pushAll:function(t){return je(this,function(e){return e.pushAll(t)})},peek:function(){return this.__deref().peek()}},{},Br);var pn=gn.prototype;pn.toString=cn.toString,pn.equals=cn.equals,pn.__deref=cn.__deref,pn.get=cn.get,pn.getIn=cn.getIn,pn.push=_n.push,pn.pop=_n.pop,pn.slice=_n.slice,pn.clear=cn.clear,pn.withMutations=cn.withMutations,pn.asMutable=cn.asMutable,pn.asImmutable=cn.asImmutable,pn.wasAltered=cn.wasAltered,pn.__iterate=cn.__iterate,pn.__iterator=cn.__iterator,pn.__ensureOwner=cn.__ensureOwner;var mn={Sequence:ar,Map:yr,Vector:Rr,Stack:Br,Set:Tr,OrderedMap:Qr,Record:Zr,Range:tn,Repeat:un,is:n,fromJS:Me,isCursor:xe,unCursor:Oe};return mn}"object"==typeof exports?module.exports=t():"function"==typeof define&&define.amd?define(t):Immutable=t();