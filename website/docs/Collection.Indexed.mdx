...
<Signature
  code={`get<NSV>(index: number, notSetValue: NSV): T | NSV;
...
<Signature
  code={`zip<U>(other: Collection<unknown, U>): Collection.Indexed<[T, U]>;`}
/>
<Signature
  code={`zip<U, V>(other: Collection<unknown, U>, other2: Collection<unknown, V>): Collection.Indexed<[T, U, V]>;`}
/>
<Signature
  code={`zip(...collections: Array<Collection<unknown, unknown>>): Collection.Indexed<unknown>;`}
/>
...
<Signature
  code={`zipAll<U>(other: Collection<unknown, U>): Collection.Indexed<[T, U]>;`}
/>
<Signature
  code={`zipAll<U, V>(other: Collection<unknown, U>, other2: Collection<unknown, V>): Collection.Indexed<[T, U, V]>;`}
/>
<Signature
  code={`zipAll(...collections: Array<Collection<unknown, unknown>>): Collection.Indexed<unknown>;`}
/>
...
/>
<Signature
  code={`zipWith<U, V, Z>(zipper: (value: T, otherValue: U, thirdValue: V) => Z, otherCollection: Collection<unknown, U>, thirdCollection: Collection<unknown, V>): Collection.Indexed<Z>;`}
/>
<Signature
  code={`zipWith<Z>(zipper: (...values: Array<unknown>) => Z, ...collections: Array<Collection<unknown, unknown>>): Collection.Indexed<Z>;`}
/>
...
<Signature
  code={`concat<C>(...valuesOrCollections: Array<Iterable<C> | C>): Collection.Indexed<T | C>;`}
/>
...
<Signature
  code={`map<M>(mapper: (value: T, key: number, iter: this) => M, context?: unknown): Collection.Indexed<M>;`}
/>
...
<Signature
  code={`flatMap<M>(mapper: (value: T, key: number, iter: this) => Iterable<M>, context?: unknown): Collection.Indexed<M>;`}
/>
...
<Signature
  code={`filter<F extends T>(predicate: (value: T, index: number, iter: this) => value is F, context?: unknown): Collection.Indexed<F>;`}
/>
<Signature
...
<Signature
  code={`partition<F extends T, C>(predicate: (this: C, value: T, index: number, iter: this) => value is F, context?: C): [Collection.Indexed<T>, Collection.Indexed<F>];`}
/>
<Signature
