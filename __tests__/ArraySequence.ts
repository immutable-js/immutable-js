...
// TODO: this test is kind of insane. Replace it with something more reasonable.
...
//
//    expect(i.slice(6, null, /*maintainIndices*/true).reverse().toKeyedSeq().reverse().entrySeq().toArray()).toEqual([
//      [6, 3],
//      [5, undefined],
//      [4, 4],
//      [3, undefined],
...
//    ]);
//
//    expect(i.slice(6, null, /*maintainIndices*/true).toKeyedSeq().reverse(true).reverse().entrySeq().toArray()).toEqual([
//      [6, 3],
//      [5, undefined],
//      [4, 4],
//      [3, undefined],
...
//    ]);
//
//    expect(i.toKeyedSeq().reverse().slice(6).reverse().entrySeq().toArray()).toEqual([
//      [0, undefined],
//      [1, undefined],
//      [2, 1],
//      [3, undefined],
