...
describe('sort', () => {
  it('sorts a sequence', () => {
    expect(Seq.of(4, 5, 6, 3, 2, 1).sort().toArray()).toEqual([
      1,
      2,
      3,
      4,
  ...
  it('sorts a list', () => {
    expect(List.of(4, 5, 6, 3, 2, 1).sort().toArray()).toEqual([
      1,
      2,
      3,
      4,
  ...
  it('sorts undefined values last', () => {
    expect(
      List.of(4, undefined, 5, 6, 3, undefined, 2, 1).sort().toArray(),
  ...
  it('accepts a sort function', () => {
    expect(Seq.of(4, 5, 6, 3, 2, 1).sort((a, b) => b - a).toArray()).toEqual([
      6,
      5,
      4,
      3,
