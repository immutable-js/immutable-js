...
describe('join', () => {
  ...
  it('string-joins sequences with commas by default', () => {
    expect(I.Sequence.of(1,2,3,4,5).join()).toBe('1,2,3,4,5');
  })

  it('string-joins sequences with any string', () => {
    expect(I.Sequence.of(1,2,3,4,5).join('foo')).toBe('1foo2foo3foo4foo5');
  })

  it('string-joins sequences with empty string', () => {
    expect(I.Sequence.of(1,2,3,4,5).join('')).toBe('12345');
  })
