...
interface CollectionImpl<K, V> {
  ...
  countBy<G>(grouper: (value: V, key: K, iter: this) => G, context?: unknown): any;
  entrySeq(): any;
  ...
  flatMap<M>(mapper: (value: V, key: K, iter: this) => Iterable<M>, context?: unknown): any;
  flatten(depth?: number | boolean): any;
  fromEntrySeq(): any;
  get<NSV>(searchKey: K, notSetValue: NSV): V | NSV;
  get(searchKey: K): V | undefined;
  getIn(searchKeyPath: Iterable<unknown>, notSetValue?: unknown): unknown;
  groupBy<G>(grouper: (value: V, key: K, iter: this) => G, context?: unknown): any;
...
interface KeyedCollectionImpl<K, V> {
  flip(): any;
  mapEntries<KM, VM>(mapper: (entry: [K, V], index: number, iter: this) => [KM, VM] | undefined, context?: unknown): any;
  mapKeys<M>(mapper: (key: K, value: V, iter: this) => M, context?: unknown): any;
}
...
interface IndexedCollectionImpl<T> {
  toKeyedSeq(): any;
  ...
  zipWith<U, Z>(zipper: (...values: Array<any>) => Z, ...collections: Array<any>): any;
}
