...
export class CollectionImpl<K, V> implements ValueObject {
  ...
  concat<C>(
    ...
    const { reify } = getOperations(); return reify(this, concatFactory(this, valuesOrCollections));
  }
  ...
  filter(
    ...
    const { reify } = getOperations(); return reify(this, filterFactory(this, predicate, context, true));
  }
  ...
  map<M>(
    ...
    const { reify } = getOperations(); return reify(this, mapFactory(this, mapper, context));
  }
  ...
  reverse(): this {
    const { reify } = getOperations(); return reify(this, reverseFactory(this, true));
  }

  slice(begin?: number, end?: number): this {
    const { reify } = getOperations(); return reify(this, sliceFactory(this, begin, end, true));
  }
  ...
  sort(comparator?: (valueA: V, valueB: V) => number): this {
    const { reify } = getOperations(); return reify(this, sortFactory(this, comparator));
  }
  ...
  flatMap<M>(
    ...
    const { reify } = getOperations(); return reify(this, flatMapFactory(this, mapper, context));
  }

  flatten(depth?: number | boolean): CollectionImpl<unknown, unknown> {
    const { reify } = getOperations(); return reify(this, flattenFactory(this, depth as any, true));
  }
  ...
  skipWhile(
    ...
    const { reify } = getOperations(); return reify(this, skipWhileFactory(this, predicate, context, true));
  }
  ...
  sortBy<C>(
    ...
    const { reify } = getOperations(); return reify(this, sortFactory(this, comparator, comparatorValueMapper));
  }
  ...
  takeWhile(
    ...
    const { reify } = getOperations(); return reify(this, takeWhileFactory(this, predicate, context));
  }
...
export class KeyedCollectionImpl<K, V> extends CollectionImpl<K, V> {
  ...
  flip(): any {
    const { reify } = getOperations(); return reify(this, flipFactory(this));
  }
  ...
  implements OrderedCollection<T>
{
  ...
  override filter(
    ...
    const { reify } = getOperations(); return reify(this, filterFactory(this, predicate, context, false));
  }
  ...
  override reverse(): this {
    const { reify } = getOperations(); return reify(this, reverseFactory(this, false));
  }

  override slice(begin?: number, end?: number): this {
    const { reify } = getOperations(); return reify(this, sliceFactory(this, begin, end, false));
  }
  ...
  override flatten(depth?: number | boolean): this {
    const { reify } = getOperations(); return reify(this, flattenFactory(this, depth as any, false));
  }
  ...
  interpose(separator: T): this {
    const { reify } = getOperations(); return reify(this, interposeFactory(this, separator));
  }
  ...
  override skipWhile(
    ...
    const { reify } = getOperations(); return reify(this, skipWhileFactory(this, predicate, context, false));
  }

  zip<U>(...collections: Array<any>): any {
    const thisAndCollections = [this].concat(collections);
    const { reify } = getOperations(); return reify(this, zipWithFactory(this, defaultZipper, thisAndCollections));
  }
  ...
  zipWith<U, Z>(
    ...
    const thisAndCollections = [this].concat(collections);
    const { reify } = getOperations(); return reify(this, zipWithFactory(this, zipper, thisAndCollections));
  }
}
