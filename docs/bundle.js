...
var TypeDef = React.createClass({displayName: 'TypeDef',
  render: function() {
    ...
    switch (type.k) {
      ...
      case TypeKind.QualifiedType: return React.createElement("span", null, 
        [type.qualifier, '.', React.createElement(TypeDef, {type: type.type})]
      )
    }
