    ...
    return (
      React.createElement("div", null, 
        ...
        (type.call || type.module) && [
          React.createElement("h2", null, "Functions"),
          React.createElement("ul", null, 
            type.call && React.createElement("li", null, typeName + '()'), 
        ...
        type.interface && React.createElement("section", null, 
          React.createElement("h3", null, 
            ...
            type.interface.typeParams &&
              ['<', Seq(type.interface.typeParams).map(function(t)  {return React.createElement("span", null, t);}).interpose(', ').toArray(), '>']
          ...
          type.interface.groups && type.interface.groups.map(function(g)  {return [
            ...
            React.createElement("ul", null, 
              Seq(g.properties).map(function(p, propName) 
                {return React.createElement("li", null, propName);}
              ).toArray(), 
              Seq(g.methods).map(function(m, methodName) 
                {return React.createElement("li", null, methodName + '()');}
              ).toArray()
            )
          ];})
        )
...
},{"../../../resources/immutable.d.json":51,"immutable":undefined,"react":undefined,"react-router":14}],1:[function(require,module,exports){
/*!
