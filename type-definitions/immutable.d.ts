...
declare module 'immutable' {
  namespace Immutable {
     ...
     * use the `new` keyword during construction.
     */
    function Collection<I extends Collection<unknown, unknown>>(
      collection: I,
    ): I;
    ...
    function remove<TProps extends object,
      C extends Record<TProps>,
      K extends keyof TProps>(collection: C, key: K): C;
    ...
    function set<TProps extends object,
      C extends Record<TProps>,
      K extends keyof TProps>(record: C, key: K, value: TProps[K]): C;
    function set<V, C extends Array<V>>(
      collection: C,
      key: number,
      value: V,
    ): C;
    ...
    function update<TProps extends object,
      C extends Record<TProps>,
      K extends keyof TProps>(record: C, key: K, updater: (value: TProps[K]) => TProps[K]): C;
    function update<TProps extends object,
      C extends Record<TProps>,
