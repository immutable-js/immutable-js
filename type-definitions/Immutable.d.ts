...
declare module Immutable {
  ...
  export interface Set<T> extends Collection.Set<T> {
     ...
     */
    flatMap<M>(
      mapper: (value: T, key: void, iter: this) => Iterable<M>,
      context?: any
    ): Set<M>;
     ...
     */
    filter<F extends T>(
      predicate: (value: T, key: void, iter: this) => value is F,
      context?: any
    ): Set<F>;
    filter(
      predicate: (value: T, key: void, iter: this) => any,
      context?: any
    ): this;
  }
  ...
  export module Seq {
    ...
    export interface Set<T> extends Seq<void, T>, Collection.Set<T> {
      /**
  ...
  export module Collection {
    ...
    export interface Set<T> extends Collection<void, T> {
      /**
